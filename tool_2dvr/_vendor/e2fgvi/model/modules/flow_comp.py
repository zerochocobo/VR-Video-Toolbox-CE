...
def _conv_module(in_channels, out_channels, kernel_size, stride, padding, act=True):
    return _ConvModule(in_channels, out_channels, kernel_size, stride, padding, act=act)
...
class SPyNetBasicModule(nn.Module):
    ...
    def __init__(self):
        ...
        self.basic_module = nn.Sequential(
            _conv_module(8, 32, 7, 1, 3, act=True),
            _conv_module(32, 64, 7, 1, 3, act=True),
            _conv_module(64, 32, 7, 1, 3, act=True),
            _conv_module(32, 16, 7, 1, 3, act=True),
            _conv_module(16, 2, 7, 1, 3, act=False))
