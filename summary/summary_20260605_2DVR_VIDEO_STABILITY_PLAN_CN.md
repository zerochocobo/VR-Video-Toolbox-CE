# tool_2dvr 视频时序稳定性改造计划（已废弃，见 v2）

> ⚠️ **本版已被 `summary_20260606_2DVR_VIDEO_STABILITY_PLAN_CN.md` 取代**。
> Stage-1 FPS commit（`45cbdbf` + `5969dd7`）落地后本版的多处代码假设失效，
> 请勿按本版开发。修订原因与差异详见 v2 第 0 节。
